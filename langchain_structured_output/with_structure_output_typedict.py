...
class schema(TypedDict):
    ...
    sentiment:Annotated[Literal["pos",'neg'] , "sentiment of review "]
    name:Annotated[Optional[str],"name of writer"]
    pros : Annotated[Optional[list[str]],"list all pros if present in review"]
    cons : Annotated[Optional[list[str]],"list of all cons present in review"]
